...
"""
The purpose of this script is to provide an example of how to use the YFinanceDataProvider.
...
def main():
    ...
    prices = data_provider.historical_price(YFinanceTicker("000001.SS", SecurityType.INDEX), PriceField.Close,
                                            nr_of_bars=5)
    print(prices)
